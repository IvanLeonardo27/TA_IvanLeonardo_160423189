...
<div class="container-fluid py-4" style="max-width: 1240px;">
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden" style="background: linear-gradient(135deg, #16402E 0%, #1F523D 100%); color: #ffffff;">
        <div class="card-body p-4 p-md-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
            ...
            <div class="d-flex align-items-center gap-3 flex-wrap w-100 w-md-auto mt-2 mt-md-0">
                ...
                <a href="{{ route('admin.users.students.create') }}" class="btn btn-light rounded-pill px-4 py-2.5 fw-bold btn-bouncy shadow-sm w-100 w-sm-auto text-center" style="color: #16402E !important; font-size: 0.9rem;">
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4" style="background:#ffffff; border: 1px solid #E2E8F0 !important;">
        <div class="card-body p-3.5">
            <form action="{{ route('admin.users.students.index') }}" method="GET" class="row g-3 align-items-center">
                <div class="col-md-5">
                ...
                <div class="col-md-4 text-md-end">
                    <div class="d-flex align-items-center gap-2 justify-content-md-end flex-wrap">
                        ...
                        <a href="{{ route('admin.users.students.index') }}" class="btn btn-outline-secondary rounded-pill px-3.5 py-2 btn-sm">
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden" style="background:#ffffff; border: 1px solid #E2E8F0 !important;">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0 text-nowrap" style="font-size:0.92rem; min-width: 860px;">
