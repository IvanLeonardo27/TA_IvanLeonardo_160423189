...
@section('title', 'Edit Pelajar - Admin BasaKula')
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div>
                    <h4 class="fw-bold text-main mb-1">
                        <i class="fa-solid fa-user-pen text-info me-2"></i> Edit Akun Pelajar
                    </h4>
                    <p class="text-muted small mb-0">Perbarui data profil, email, password, atau status akun pelajar.</p>
                </div>
                <div class="text-end">
                    <span class="small text-muted d-block">Kode Pelajar Terdaftar:</span>
            ...
            <form action="{{ route('admin.users.students.update', $user) }}" method="POST">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nisn" class="form-control rounded-3" 
                               value="{{ old('nisn', $user->studentProfile->nisn ?? '') }}">
                    </div>
                </div>
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="grade_level" class="form-control rounded-3" 
                               value="{{ old('grade_level', $user->studentProfile->grade_level ?? '') }}">
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center justify-content-end gap-2 pt-3 border-top">
                    ...
                    <button type="submit" class="btn btn-info text-white rounded-pill px-4 fw-bold btn-bouncy shadow-sm">
                        <i class="fa-solid fa-save me-1.5"></i> Perbarui Data Pelajar
                    </button>
                </div>
            </form>
        </div>
