...
<div class="container-fluid py-4" style="max-width: 1100px;">
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2.5 mb-4">
        <a href="{{ route('teacher.classroom.show', $classroom) }}" class="btn btn-outline-secondary rounded-pill px-3.5 py-2 btn-sm fw-semibold shadow-xs">
            <i class="fa-solid fa-arrow-left me-1"></i> Kembali ke Kelas
        </a>
        <div class="d-flex align-items-center flex-wrap gap-2">
            <span class="badge bg-primary rounded-pill px-3 py-1.5 fw-bold text-nowrap"><i class="fa-solid fa-book-open me-1"></i> Pratinjau Materi Pengajar</span>
